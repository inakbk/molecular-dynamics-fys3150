...
{\Huge Using Molecular dynamics to calculate the melting temperature of a face centered cubic lattice crystal consisting of Argon atoms}\\[0.75\baselineskip] % Title line 1
...
&
\begin{minipage}{0.45\textwidth}
\includegraphics[width=\textwidth]{plots/programStructure}
\end{minipage}
...
\caption{\textbf{Top:} The diffusion constant $D$ plotted versus the time with 10000 timesteps for initial temperatures $T_i \in [0.5, 18.5]$. \textbf{Bottom:} The mean square displacement $\langle r^2(t) \rangle$ of the particles plotted versus the time with 10000 timesteps for initial temperatures $T_i \in [0.5, 18.5]$. The units are the MD units listed in appendix \ref{sec:units}.}
\label{fig: D_r2_time}
\end{figure}
